...
// ============ Meshes ============
// GLTF Mesh
new GLTFLoader().load("./threejs/reconers_v15.glb", (gltf) => {
  ...
  model.traverse((child) => {
      if (child.isMesh) {
        ...
        reflectMesh.scale.set(0.2, 0.6, 0.2);
        normalMesh.scale.set(0.2, 0.6, 0.2);
...
let targetRotation = { x: 0 / 2, y: 0 , z: 0 }; // 도형 각도 
