...
import { Group } from "https://cdn.jsdelivr.net/npm/three@0.170.0/src/objects/Group.js";
...
new GLTFLoader().load("./threejs/reconers_v2.glb", (gltf) => {
  ...
  model.traverse((child) => {
      if (child.isMesh) {
        ...
        meshReflect.scale.set(0.083, 0.084, 0.23);
        meshNormal.scale.set(0.083, 0.084, 0.23);
